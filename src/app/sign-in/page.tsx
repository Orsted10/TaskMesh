...
import { Shield, Mail, Lock, Zap, Target } from "lucide-react"
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="font-teko text-xl text-primary tracking-widest uppercase">Secure Access</span>
          </div>
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="font-teko text-xl text-muted-foreground tracking-widest">OR OVERRIDE WITH</span>
            <div className="h-[1px] flex-1 bg-muted/30" />
          </div>
          ...
          <p className="mt-8 text-center font-sans text-sm text-foreground/60">
            Don't have clearance? <Link href="/sign-up" className="text-primary hover:underline font-bold cursor-none">Sign Up Here</Link>
          </p>
        </div>
      </motion.div>
    </div>
